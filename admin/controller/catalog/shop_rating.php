...
class ControllerCatalogShopRating extends Controller {
    ...
    public function index() {
        ...
        if(!$installed){
            $this->response->redirect($this->url->link('catalog/shop_rating/install', 'token=' . $this->session->data['token'], true));
        }
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            ...
            $this->response->redirect($this->url->link('catalog/shop_rating', 'token=' . $this->session->data['token'], true));
        }
        ...
        $data['action'] = $this->url->link('catalog/shop_rating', 'token=' . $this->session->data['token'], true);

        $data['cancel'] = $this->url->link('extension/extension', 'token=' . $this->session->data['token'], true);
        $data['change_status'] = $this->url->link('catalog/shop_rating/status', 'token=' . $this->session->data['token'], true);
        $data['view_rate_link'] = $this->url->link('catalog/shop_rating/viewRate', 'token=' . $this->session->data['token'], true);
        $data['create_custom_type_url'] = $this->url->link('catalog/shop_rating/custom_types', 'token=' . $this->session->data['token'], true);
        ...
        $data['order_statuses'] = $this->model_localisation_order_status->getOrderStatuses();
            ...
            $data['breadcrumbs'][] = array(
                ...
                'href' => $this->url->link('catalog/shop_rating', 'token=' . $this->session->data['token'], true)
            );
    ...
    public function viewRate(){
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            ...
            $this->response->redirect($this->url->link('catalog/shop_rating/viewRate', 'token=' . $this->session->data['token'].'&rating_id='.$rate_id, true));
        }
        ...
        $data['action'] = $this->url->link('catalog/shop_rating/viewRate', 'token=' . $this->session->data['token'].'&rating_id='.$rate_id, true);

        $data['cancel'] = $this->url->link('catalog/shop_rating', 'token=' . $this->session->data['token'], true);

        $data['change_status_url'] = $this->url->link('catalog/shop_rating/status', 'token=' . $this->session->data['token'], true);
        ...
        if (!isset($this->request->get['module_id'])) {
            ...
            $data['breadcrumbs'][] = array(
                ...
                'href' => $this->url->link('catalog/shop_rating/viewRate', 'token=' . $this->session->data['token']. '&rating_id=' . $rate_id, true)
            );
        } else {
            $data['breadcrumbs'][] = array(
                'text' => $this->language->get('heading_title'),
                'href' => $this->url->link('catalog/shop_rating/', 'token=' . $this->session->data['token'] . '&module_id=' . $this->request->get['module_id'], true)
            );
            $data['breadcrumbs'][] = array(
                'text' => $this->language->get('heading_title_view').$rate_id,
                'href' => $this->url->link('catalog/shop_rating/viewRate', 'token=' . $this->session->data['token'] .'&rating_id=' . $rate_id. '&module_id=' . $this->request->get['module_id'], true)
            );
        }
