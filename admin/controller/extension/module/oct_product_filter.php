...
class ControllerExtensionModuleOctProductFilter extends Controller {
    ...
    public function index() {
        ...
        if (!isset($data['oct_product_filter_data']['meta_robots'])) {
            $data['oct_product_filter_data']['meta_robots'] = 'noindex, nofollow';
        }

        if (!isset($data['oct_product_filter_data']['index_w_page'])) {
            $data['oct_product_filter_data']['index_w_page'] = 1;
        }

        if (!isset($data['oct_product_filter_data']['canonicial_view'])) {
            $data['oct_product_filter_data']['canonicial_view'] = 1;
        }
