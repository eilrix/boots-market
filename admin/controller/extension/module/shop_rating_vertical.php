...
class ControllerExtensionModuleShopRatingVertical extends Controller {
    ...
    public function index() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            ...
            $this->response->redirect($this->url->link('extension/module/shop_rating_vertical', 'token=' . $this->session->data['token'], true));
        }
        ...
        $data['action'] = $this->url->link('extension/module/shop_rating_vertical', 'token=' . $this->session->data['token'], true);
        ...
        if (!isset($this->request->get['module_id'])) {
            $data['breadcrumbs'][] = array(
                ...
                'href' => $this->url->link('extension/module/shop_rating_vertical', 'token=' . $this->session->data['token'], true)
            );
        } else {
            $data['breadcrumbs'][] = array(
                'text' => $this->language->get('heading_title'),
                'href' => $this->url->link('extension/module/shop_rating_vertical', 'token=' . $this->session->data['token'] . '&module_id=' . $this->request->get['module_id'], true)
            );
        }
        ...
        $this->response->setOutput($this->load->view('extension/module/shop_rating_vertical', $data));
    }
