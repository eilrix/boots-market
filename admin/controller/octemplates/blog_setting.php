    ...
    if (isset($this->request->post['oct_blog_setting_data']['language'])) {
      foreach ($this->request->post['oct_blog_setting_data']['language'] as $language_id => $value) {
        ...
        if ((utf8_strlen($value['seo_meta_description']) < 1) || (utf8_strlen($value['seo_meta_description']) > 255)) {
          $this->error['seo_meta_description'][$language_id] = $this->language->get('error_for_all_field');
        }
        
        if ((utf8_strlen($value['seo_meta_keywords']) < 1) || (utf8_strlen($value['seo_meta_keywords']) > 255)) {
          $this->error['seo_meta_keywords'][$language_id] = $this->language->get('error_for_all_field');
        }
        
        if (utf8_strlen($value['seo_description']) < 1) {
          $this->error['seo_description'][$language_id] = $this->language->get('error_for_all_field');
        }
      }
    }
