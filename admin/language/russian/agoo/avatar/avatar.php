<?php
$_['text_widget_avatar'] = 'Аватар';
$_['text_widget_avatar_settings']       = 'Аватары';
$_['order_avatar'] = '21';
$_['entry_anchor_templates'] = 'Шаблоны привязок';
$_['entry_anchor_value'] = 'Текущая величина';
$_['entry_anchor_templates_clear'] = 'Очистить';
$_['entry_anchor_templates_avatar'] = 'В личном кабинете (default)';
$_['entry_anchor_templates_avatar_reviews'] = 'В отзывах (default)';
