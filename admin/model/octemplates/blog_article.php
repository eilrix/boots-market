    ...
    public function addArticle($data) {
        ...
        if (isset($data['product_related'])) {
            foreach ($data['product_related'] as $product_related_id) {
                ...
                // $this->db->query("DELETE FROM " . DB_PREFIX . "oct_blog_article_products_related WHERE oct_blog_article_id = '" . (int)$product_related_id . "' AND product_related_id = '" . (int)$oct_blog_article_id . "'");
                // $this->db->query("INSERT INTO " . DB_PREFIX . "oct_blog_article_products_related SET oct_blog_article_id = '" . (int)$product_related_id . "', product_related_id = '" . (int)$oct_blog_article_id . "'");
            }
        }
