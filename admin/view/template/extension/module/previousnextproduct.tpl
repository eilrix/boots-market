                ...
                <input type="hidden" name="store_id" value="<?php echo $store['store_id']; ?>" />
                  <input type="hidden" name="previousnextproduct_status" value="1" />
                    ...
                    <?php
                        ...
                        <div id="support" class="tab-pane fade"><?php require_once modification_vqmod(DIR_APPLICATION.'view/template/extension/module/previousnextproduct/tab_support.php'); ?></div>
                    </div> <!-- /.tab-content --> 
                </div><!-- /.tabbable -->
            </form>
        </div> 
