  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        ...
        <div class="pull-right"><h3><strong>version 2.9</strong></h3></div>
      </div>
                ...
                <table class="form">
                    ...
                    <td>
                      <div class="btn-group" data-toggle="buttons">
                        <label class="btn btn-info btn-info-green <?php echo $value_001 == '1' ? 'active' : ''; ?>">
                          <input type="radio"
                            name="k4a4s474x55444b4o4x5m4k4m5h5q4t434m426k4"
                            value="1"
                            autocomplete="off"
                            style="display: none;"
                    ...
                    <td>
                      <div class="btn-group" data-toggle="buttons">
                        <label class="btn btn-info <?php echo (isset($value_002['oct_lazyload']) && $value_002['oct_lazyload'] == '1') ? 'active' : ''; ?>">
                          <input type="radio"
                            name="k4a4s474x55444b4o4x5m4k4m5h5b4a4m434[oct_lazyload]"
                            value="1"
                            autocomplete="off"
                            style="display: none;"
                    ...
                    <td>
                      <div class="btn-group" data-toggle="buttons">
                        <label class="btn btn-info <?php echo (isset($value_002['oct_lazyload_module']) && $value_002['oct_lazyload_module'] == '1') ? 'active' : ''; ?>">
                          <input type="radio"
                            name="k4a4s474x55444b4o4x5m4k4m5h5b4a4m434[oct_lazyload_module]"
                            value="1"
                            autocomplete="off"
                            style="display: none;"
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <input type="hidden" name="k4a4s474x55444b4o4x5m4k4m5h5b4a4m434[oct_lazyload_image]" value="<?php echo (isset($value_002['oct_lazyload_image']) && $value_002['oct_lazyload_image']) ? $value_002['oct_lazyload_image'] : 'catalog/1lazy/oct_loader_product.gif'; ?>" id="input-image" />
                    </td>
                  </tr>
                  <tr>
                        ...
                        <tr>
                          <td colspan="2">
                            ...
                            <table id="foot_garantedtext" class="table table-bordered">
                              ...
                              <tbody>
                                <?php $foot_garantedtext_row = 0; if (isset($value_002['foot_garantedtext']) && !empty($value_002['foot_garantedtext'])) { ?>
              ...
              <div id="tab_contacts" class="tab-pane fade">
                <table class="form">
                  <tr>
                    ...
                    <td><textarea style="min-height: 100px;" name="k4a4s474x55444b4o4x5m4k4m5h5b4a4m434[cont_phones]" id="oct_techstore_cont_phones" class="form-control"><?php echo $value_002['cont_phones']; ?></textarea></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td>
                      <?php foreach ($languages as $language) { ?>
                        <div class="input-group">
                          <span class="input-group-addon"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /></span>
                          <textarea style="min-height: 100px;" name="k4a4s474x55444b4o4x5m4k4m5h5b4a4m434[cont_adress][<?php echo $language['code']; ?>]" id="oct_techstore_cont_adress<?php echo $language['code']; ?>" class="form-control"><?php echo isset($value_002['cont_adress'][$language['code']]) ? $value_002['cont_adress'][$language['code']] : ''; ?></textarea>
                        </div><br />
                      <?php } ?>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <?php foreach ($languages as $language) { ?>
                        <div class="input-group">
                          <span class="input-group-addon"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /></span>
                          <textarea style="min-height: 100px;" name="k4a4s474x55444b4o4x5m4k4m5h5b4a4m434[cont_clock][<?php echo $language['code']; ?>]" id="oct_techstore_cont_clock<?php echo $language['code']; ?>" class="form-control"><?php echo isset($value_002['cont_clock'][$language['code']]) ? $value_002['cont_clock'][$language['code']] : ''; ?></textarea>
                        </div><br />
                      <?php } ?>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <?php foreach ($languages as $language) { ?>
                        <div class="input-group">
                          <span class="input-group-addon"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /></span>
                          <textarea style="min-height: 100px;" name="k4a4s474x55444b4o4x5m4k4m5h5b4a4m434[cont_contacthtml][<?php echo $language['code']; ?>]" id="oct_techstore_cont_contacthtml<?php echo $language['code']; ?>" class="form-control"><?php echo isset($value_002['cont_contacthtml'][$language['code']]) ? $value_002['cont_contacthtml'][$language['code']] : ''; ?></textarea>
                        </div><br />
                      <?php } ?>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td><textarea style="min-height: 100px;" name="k4a4s474x55444b4o4x5m4k4m5h5b4a4m434[cont_contactmap]" id="oct_techstore_cont_contactmap" class="form-control"><?php echo $value_002['cont_contactmap']; ?></textarea></td>
                  </tr>
                </table>
              </div>
...
<?php } else { ?>
$('#pr_additional_tab_text-<?php echo $language['code']; ?>').summernote({height: 300, lang:'<?php echo $language['code']; ?>'});
<?php } ?>
<?php } ?>
//--></script>
<script type="text/javascript"><!--
