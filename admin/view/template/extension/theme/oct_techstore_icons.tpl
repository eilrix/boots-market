<div class="oct-fontawesome-icons">
	...
	<div class="row" style="padding:0 15px">
		...
		<div class="col-xs-1"><i class="fa fa-square" aria-hidden="true"></i>square</div>
		<div class="col-xs-1"><i class="fa fa-square-o" aria-hidden="true"></i></div>
	</div>
	...
	<div class="row" style="padding:0 15px">
		...
		<div class="col-xs-1"><i class="fa fa-fa" aria-hidden="true"></i></div>
		...
		<div class="col-xs-1"><i class="fa fa-google-plus-circle" aria-hidden="true"></i></div>
...
<style type="text/css">
	.oct-fontawesome-icons .col-xs-1 i {
		padding: 6px;
	}
	.oct-fontawesome-icons .col-xs-1 i:hover {
		background: #e5e5e5;
		border-radius: 3px;
		cursor: pointer;
	}
...
<?php if ($type == 1) { ?>
	$('.col-xs-1 i').on('click', function() {
		$('#pr_garantedtext_icon-<?php echo $block_id; ?>').attr('class', $(this).attr('class'));
		$('#pr_garantedtext_icon-input-<?php echo $block_id; ?>').val($(this).attr('class'));

		$('#modal-icons').modal('hide');
	});
<?php } else if ($type == 2) { ?>
	$('.col-xs-1 i').on('click', function() {
		$('#foot_garantedtext_icon-<?php echo $block_id; ?>').attr('class', $(this).attr('class'));
		$('#foot_garantedtext_icon-input-<?php echo $block_id; ?>').val($(this).attr('class'));
