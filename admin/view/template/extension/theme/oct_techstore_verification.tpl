            ...
            <div class="col-sm-12">
              ...
              <table class="form">
                <tr>
                  ...
                  <td class="no-style">
                    <input type="text" name="oct_techstore_verification" value="<?php echo $oct_techstore_verification; ?>" placeholder="xxxxxxxx-xxxxxxxx-xxxxxxxx-xxxxxxxx" class="form-control" />
                    <br/>
