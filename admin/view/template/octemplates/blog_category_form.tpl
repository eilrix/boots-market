          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="oct_blog_category_parent_id" class="form-control">
                    <option value="0" selected="selected"><?php echo $text_none; ?></option>
                    <?php foreach ($categories as $category) { ?>
                    <?php if ($category['oct_blog_category_id'] == $oct_blog_category_parent_id) { ?>
...
$('input[name=\'cpath\']').autocomplete({
  ...
  'select': function(item) {
    ...
    $('input[name=\'oct_blog_category_parent_id\']').val(item['value']);
  }
});
//--></script>  
<script type="text/javascript"><!--
