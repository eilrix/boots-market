        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-review" class="form-horizontal">
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              ...
              <input type="hidden" name="oct_blog_article_id" value="<?php echo $oct_blog_article_id; ?>" />
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <input type="text" name="plus" value="<?php echo $plus; ?>" placeholder="<?php echo $entry_plus; ?>" id="input-plus" class="form-control" />
            </div>
          </div>
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-minus"><?php echo $entry_minus; ?></label>
            <div class="col-sm-10">
              <input type="text" name="minus" value="<?php echo $minus; ?>" placeholder="<?php echo $entry_minus; ?>" id="input-minus" class="form-control" />
            </div>
          </div>
...
$('input[name=\'article\']').autocomplete({
	...
	'select': function(item) {
		...
		$('input[name=\'oct_blog_article_id\']').val(item['value']);		
	}	
});
//--></script>
</div>
