...
class ControllerExtensionModuleOCFilter extends Controller {
  ...
  public function decode() {
    ...
    foreach ($keywords as $key => $keyword) {
      ...
      // Values
      if ($current == 's' && isID($keyword) && $this->config->get('ocfilter_stock_status_method') == 'stock_status') {
      ...
      // Options
      if ($keyword == 'sklad' && $this->config->get('ocfilter_stock_status_method') == 'stock_status') {
      	$params['s'] = array();
