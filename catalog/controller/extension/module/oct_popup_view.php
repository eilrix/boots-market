...
class ControllerExtensionModuleOctPopupView extends Controller {
    public function index() {
        ...
        //Get partner link
        $data['partner_link'] = $product_info['location'];

        $partner_store_name = $product_info['ean'];
        $partner_store_name = str_replace(".ru","", $partner_store_name);
        $partner_store_name = str_replace(".com","", $partner_store_name);
        $partner_store_name = ucfirst($partner_store_name);
        $data['partner_store_name'] = $partner_store_name;
...
*/
            if ($product_info['image']) {
                $data['thumb'] = $this->model_tool_image->resize($product_info['image'], 600, 600);
            } else {
                $data['thumb'] = $this->model_tool_image->resize("placeholder.png", 600, 600);
            }
