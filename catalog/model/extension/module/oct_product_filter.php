...
class ModelExtensionModuleOctProductFilter extends Model {
    ...
    public function getFilterMINMAXPrices($global_id, $global_type, $store_id, $customer_group_id, $data = array(), $lead_time_status = false) {
        ...
        if ($product_ids) {
            ...
            return array(
                'low_price' => ($query['low_price'] == $query['high_price']) ? --$query['low_price'] : $query['low_price'],
                'high_price' => ($query['low_price'] == $query['high_price']) ? ++$query['high_price'] : $query['high_price']
            );
        } else {
            return array(
                'low_price' => 0,
