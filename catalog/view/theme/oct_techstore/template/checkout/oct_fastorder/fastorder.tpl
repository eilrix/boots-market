								...
								<div class="panel-body">
									<?php if ($oct_fastorder_data['customer_groups'] == 1 && $customer_groups) { ?>
										<div class="form-group">
											...
											<?php foreach ($customer_groups as $customer_group) { ?>
												<div class="radio">
													<label><input type="radio" name="customer_group_id" value="<?php echo $customer_group['customer_group_id']; ?>"<?php if ($customer_group['customer_group_id'] == $customer_group_id) { ?> checked="checked"<?php } ?> /><?php echo $customer_group['name']; ?></label>
												</div>
											<?php } ?>
										</div>
									<?php } else { ?>
									...
									<div class="row">
										...
										<div id="payment-address-new" <?php if (isset($customer_id) && $addresses) { ?>style="display:none"<?php }?>>
											...
											<?php } ?>
											<?php if ($oct_fastorder_data['postcode'] == 1 || $oct_fastorder_data['postcode'] == 2) { ?>
												<div class="form-group <?php if ($oct_fastorder_data['postcode'] == 2) { ?>required<?php } ?> col-md-12">
