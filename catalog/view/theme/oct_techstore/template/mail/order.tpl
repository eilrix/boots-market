	...
	<head>
		...
		<style>
			@font-face {
				...
				src:url(https://ked-krosovkin.ru/catalog/view/theme/oct_techstore/fonts/DINPro-Light.woff) format('woff');
			}
			 *{
				font-family: 'DINProLt'!important;
			}
		</style>
	</head>
	<body style="font-size: 12px; line-height:18px; font-family: Arial, sans-serif; background: #fff; max-width: 600px; width: 100%;">
	<style>
		@font-face {
			font-family:'DINProLt';
			src:url(https://ked-krosovkin.ru/catalog/view/theme/oct_techstore/fonts/DINPro-Light.woff) format('woff');
		...
		* {
		...
		<div style="max-width: 1000px; margin: 0 auto; box-shadow: 0px 1px 4px 1px rgba(0, 0, 0, 0.2);">
			<div style="height: 30px;">&nbsp;</div>
			<div style="font-size: 14px; line-height: 24px; margin: 20px; color: #222;">
				<p style="text-align: center;">
					<a href="<?php echo $store_url; ?>" title="<?php echo $store_name; ?>"><img src="<?php echo $logo; ?>" alt="<?php echo $store_name; ?>" style="margin-bottom: 20px; border: none; height: 150px;" /></a>
				</p>
			...
			<main style="background: #fff; position: relative; box-shadow: 0 0 13px 0 rgba(0, 0, 0, .4);">
				<div class="order-details">
					<div style="border-bottom: 1px dashed #e5e5e5; padding: 20px; background: #141414; color: #fff; font-size: 16px;">
						<div class="order-wrap">
							<time style="font-size: 11px;  color: rgba(208, 208, 208, 0.96);"><?php echo $date_added; ?></time>
							<div style="float: right; font-size: 24px;"><span class="xhr">#170<?php echo $order_id; ?></span></div>
						</div>
					</div>
					...
					<div>
						<div class="order-goods">
							<table style="border-collapse: collapse; width: 100%; border-top: 1px solid #DDDDDD; border-left: 1px solid #DDDDDD; margin-bottom: 20px;">
								<thead>
									<tr>
										<td style="font-size: 12px; border-right: 1px solid #e5e5e5; background-color: #141414; font-weight: bold; text-align: left; padding: 7px; color: #fff;">&nbsp;</td>
										<td style="font-size: 12px; border-right: 1px solid #e5e5e5; background-color: #141414; font-weight: bold; text-align: left; padding: 7px; color: #fff;"><?php echo $text_product; ?></td>
										<td style="font-size: 12px; border-right: 1px solid #e5e5e5; background-color: #141414; font-weight: bold; text-align: left; padding: 7px; color: #fff;"><?php echo $text_model; ?></td>
										<td style="font-size: 12px; border-right: 1px solid #e5e5e5; background-color: #141414; font-weight: bold; text-align: right; padding: 7px; color: #fff;"><?php echo $text_quantity; ?></td>
										<td style="font-size: 12px; border-right: 1px solid #e5e5e5; background-color: #141414; font-weight: bold; text-align: right; padding: 7px; color: #fff;"><?php echo $text_price; ?></td>
										<td style="font-size: 12px; border-right: 1px solid #e5e5e5; background-color: #141414;font-weight: bold; text-align: right; padding: 7px; color: #fff;"><?php echo $text_total; ?></td>
									</tr>
								</thead>
								<tbody>
