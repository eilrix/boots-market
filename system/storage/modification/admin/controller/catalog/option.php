...
class ControllerCatalogOption extends Controller {
	...
	protected function getForm() {
        ...
        $data['text_oct_quantity'] = $this->language->get('text_oct_quantity');
        $data['text_oct_quantity_simple'] = $this->language->get('text_oct_quantity_simple');
	...
	public function autocomplete() {
		...
		if (isset($this->request->get['filter_name'])) {
			...
			foreach ($options as $option) {
				...
				if ($option['type'] == 'select' || $option['type'] == 'radio' || $option['type'] == 'checkbox' || $option['type'] == 'image' || ($option['type'] == 'oct_quantity' && isset($oct_advanced_options_settings_data['status']) && $oct_advanced_options_settings_data['status'] && $oct_advanced_options_settings_data['quantity_status'])
      ) {
        ...
        if ($option['type'] == 'oct_quantity' && isset($oct_advanced_options_settings_data['status']) && $oct_advanced_options_settings_data['status'] && $oct_advanced_options_settings_data['quantity_status']) {
          $type = $this->language->get('text_oct_quantity');
        }
        ...
        if (isset($oct_advanced_options_settings_data['status']) && $oct_advanced_options_settings_data['status'] && $oct_advanced_options_settings_data['quantity_status']) {
          $json[] = array(
