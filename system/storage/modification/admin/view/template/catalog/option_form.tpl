  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <?php if (isset($oct_advanced_options_settings_data['status']) && $oct_advanced_options_settings_data['status'] && $oct_advanced_options_settings_data['quantity_status']) { ?>
          <optgroup label="<?php echo $text_oct_quantity; ?>">
          <?php if ($type == 'oct_quantity') { ?>
          <option value="oct_quantity" selected="selected"><?php echo $text_oct_quantity_simple; ?></option>
          <?php } else { ?>
          <option value="oct_quantity"><?php echo $text_oct_quantity_simple; ?></option>
          <?php } ?>
          </optgroup>
        <?php } ?>
...
$('select[name=\'type\']').on('change', function() {
        ...
        <?php if (isset($oct_advanced_options_settings_data['status']) && $oct_advanced_options_settings_data['status'] && $oct_advanced_options_settings_data['quantity_status']) { ?>
          ...
          if (this.value == 'select' || this.value == 'radio' || this.value == 'checkbox' || this.value == 'image' || this.value == 'oct_quantity') {
