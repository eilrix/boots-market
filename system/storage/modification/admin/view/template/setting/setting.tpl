...
<li><a href="#tab-bitrix24" data-toggle="tab">Bitrix24</a></li>
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-bitrix24">
				<div class="form-group">
					<label class="col-sm-2 control-label">Email</label>
					<div class="col-sm-3">
						<input type="text" name="config_bitrix24_login" value="<?php echo $config_bitrix24_login; ?>" placeholder="account@bitrix24.ru" class="form-control" />
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label">Пароль</label>
					<div class="col-sm-3">
						<input type="text" name="config_bitrix24_password" value="<?php echo $config_bitrix24_password; ?>" placeholder="password" class="form-control" />
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label">Домен</label>
					<div class="col-sm-3">
						<input type="text" name="config_bitrix24_domain" value="<?php echo $config_bitrix24_domain; ?>" placeholder="domain.bitrix24.ru" class="form-control" />
					</div>
				</div>
			</div>
