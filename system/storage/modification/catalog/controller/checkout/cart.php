...
class ControllerCheckoutCart extends Controller {
	...
	public function add() {
        ...
        // oct_techstore start
 if (function_exists('Wbr')) { global $light_modify_cart; if (!$light_modify_cart) $cht=1; else if (VERSION<"2.0") $cht=$this->getChild('module/cart'); else $cht=$this->load->controller('common/cart'); Wbr($this->cart->countProducts(),$cht); } //Lightning 
