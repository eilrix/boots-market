...
class ControllerCommonCart extends Controller {
 ...
 if (function_exists('Wbr')) {global $li_cpr; $li_cpr = $this->cart->getProducts();} //Lightning 
		...
		$data['checkout'] = $this->url->link('checkout/checkout', '', true);
		 ...
		 $output = $this->load->view('common/cart', $data); if (function_exists('Wbr') and isset($data['products'])) Wbr(count($data['products']), $output); return $output; //Lightning 
	}

	public function info() {
		 $output = $this->index(); if (function_exists('Wbr')) Wbr(999, $output); $this->response->setOutput($output); //Lightning 
	}
}
