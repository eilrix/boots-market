...
$itr = $this->config->get('config_seo_url') ? '?' : '&';
			...
			$pagination->url = ((isset($seo_data_info) && $seo_data_info) || $oct_product_filter_status) ? ($oct_server.$itr.'page={page}') : ($this->url->link('product/manufacturer/info', 'manufacturer_id=' . $this->request->get['manufacturer_id'] .  $url . '&page={page}'));
